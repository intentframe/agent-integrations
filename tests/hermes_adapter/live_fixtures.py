...
DELETE_ALLOW_ARGS = delete_allow_args(marker=_LIVE_MARKER)
...
PATCH_V4A_MIXED_ALLOW_ARGS = patch_v4a_mixed_allow_args(marker=_LIVE_MARKER)
PATCH_V4A_BLOCK_ARGS = patch_v4a_block_args(marker=_LIVE_MARKER)

# Back-compat aliases used in docs/tests
PATCH_V4A_MIXED_ALLOW = PATCH_V4A_MIXED_ALLOW_ARGS["patch"]
